  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .BGT02      
      ...
      .row.justify-content-center.align-items-center.mb-4
        ...
        .col-lg-8
          p Uno de los aspectos más relevantes al seleccionar y combinar los medios promocionales es el conocimiento del segmento de mercado al cual se dirige la estrategia. Es decir, se debe tener en cuenta el perfil del cliente potencial, que puede incluir sus preferencias, comportamientos, edad, ubicación geográfica, nivel socioeconómico, hábitos de consumo de medios, entre otros factores. Una promoción eficaz es aquella que adapta el mensaje al canal adecuado, en el momento justo y con el lenguaje apropiado para cada tipo de público.
      .row.justify-content-center.align-items-center
        .col-lg-11(data-aos="fade-left")
          p Por tanto, la efectividad de una campaña de promoción no solo depende del mensaje en sí, sino también de la forma en que este es transmitido, el medio que se utiliza y la experiencia que se logra generar en el receptor. La promoción turística, en este sentido, no se limita a informar, sino que busca inspirar, emocionar y persuadir al turista potencial para que se conecte con el destino.

    separador
    #t_2_1.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 2.1	Tipos de medios aplicados a la promoción turística
    p.mb-4 Los medios aplicados a la promoción turística se clasifican en dos grandes categorías de comunicación, los personales y los impersonales. Cada uno desempeña un papel específico dentro de las estrategias promocionales y se selecciona de acuerdo con las características del público objetivo, el tipo de servicio turístico y los objetivos de la campaña.
    ...
    p.mb-4 Cada herramienta tiene características, funciones y costos distintos, por lo que quienes gestionan destinos turísticos deben conocerlas para seleccionar una combinación adecuada que permita posicionar el destino de manera efectiva.
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        LineaTiempoD.color-acento-botones
          .row.justify-content-center(numero="A" titulo="Publicidad")
            .col-lg-12.order-lg-1.order-2
              p Es una forma de comunicación impersonal, pagada por un anunciante, que busca informar, persuadir y generar recordación sobre un producto, servicio, idea o destino turístico. Emplea medios creativos que permiten llegar tanto a audiencias masivas como segmentadas. Los medios publicitarios se clasifican en:
              .tarjeta--BG03
